...
signals=['XToYYprimeTo4Q_MX3000_MY400_MYprime400_narrowReco']
smears=[5,10,20,30,40]
signals+=[f'XToYYprimeTo4Q_MX3000_MY400_MYprime400_narrow_smear{s}Reco' for s in smears]
signal_injections = [0.]
folds = 4
...
for signal_name in signals:
    ...
    sig_qrs = []
    for q in quantiles:
        # We use the signal from an earlier attempt
