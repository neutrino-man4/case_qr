    ...
    for sig_sample_id in signals:
        ...
        for inj in injected:    
            ...
            for b,lower in enumerate(binning):
                ...
                dist1,ind1 = kdtrees1[b].query(data_in_bin1, k=1)
                ...
                replaced_j1reco = np.expand_dims(libs_j1reco[b][flat_ind1],axis=1)
                replaced_j1kl = np.expand_dims(libs_j1kl[b][flat_ind1],axis=1)
            ...
            out_filename=paths.sample_file_path(mixed_id,additional_id=sig_sample_id,mkdir=True,overwrite=True,customname=f'data_MIXED_{sig_sample_id}_{inj}_normalized')
            #out_filename = f'/storage/9/abal/CASE/VAE_results/events/run_{run_n}/qcd_sig_orig_RECO_injected_jets/sig_MCOrig_QR_Reco_MIXED.h5'
