...
signal_name = 'XToYYprimeTo4Q_MX5000_MY170_MYprime170_narrowReco' #'XToYYprimeTo4Q_MX2000_MY400_MYprime170_narrowReco' #'WkkToWRadionToWWW_M3000_Mr170Reco'
signal_injections = [0.]
folds = 4
...
for siginj in signal_injections:
    ...
    case_qr_datasets=f'/ceph/abal/CASE/QR_datasets/run_{run_n}/QCD_MC_for_asimov/{nAttempt}'
    ...
    log_command = f'cp -r {case_qr_models}/run_{run_n}/models_lmfit_csv/QCD_MCOrig_asimov/{nAttempt}/log.txt {case_qr_datasets}/'
